...
# Dada2 sequence pipeline for Penn Rhizosphere 
...
```{r}
path = "/home/bryan/PennRhiz/data/run1/v4bac_lib1_demult/"
fns = list.files(path)
...
for(i in seq_along(fnFs)) {
  fastqPairedFilter(c(fnFs[i], fnRs[i]), c(filtFs[i], filtRs[i]),
                    trimLeft=c(10, 10), truncLen=c(140,160), 
...
saveRDS(no.chimera, "/home/bryan/PennRhiz/data/run1/v4bac_lib1_demult/lib1_seqtab.rds") 
```
...
```{r}
library(phyloseq)
sample_data = import_qiime_sample_data("/home/bryan/PennRhiz/data/run1/Penn_v4bac_lib1_mappingfile.txt")
